const courseData = {
    ...
    "lectureSubtitle": "Solve Task 8",
    "topics": [
        {
            "id": "topic-0-last-lesson",
            "title": "Last Lesson",
            "content": "<h3>Last Lesson</h3><pre class=\"lecture-pre\"><code>1- Nodemailer\n2- Update Password Cycle\n3- Deploy on Render</code></pre>",
            "examples": []
        },
        {
            "id": "topic-1-solve-task-8",
            "title": "Solve Task 8",
            "content": "<h3>Solve Task (Task Management System API Design)</h3><pre class=\"lecture-pre\"><code>https://github.com/MoonesMezher/solve-task-8---node-js-V10</code></pre>",
            "examples": []
        }
    ]
};
